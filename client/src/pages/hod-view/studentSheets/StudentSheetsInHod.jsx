...
export default function StudentSheetsHod({ user }) {
    // ----------- State manage -----------
                    ...
                    <tbody>
                        {
                            tableData ? tableData.map((data, i) => (
                                <tr key={i}>
                                    ...
                                    <td style={{color: data.grade === "F" ? "red" :"" }} >{data.grade}</td>
                                    ...
                                    {
                                        departmentData?.department?.practical === true && <td style={{color: data.practicalGrade === "F" ? "red" :"" }}>{data.practicalGrade}</td>
                                    }
                                    {
