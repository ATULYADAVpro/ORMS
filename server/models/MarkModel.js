...
const markSchema = new Schema({
  ...
  internalMax: { type: Number, required: true },
  internalMin: { type: Number, required: true },
  externalMin: { type: Number, required: true },
  externalMax: { type: Number, required: true },
  ...
  practicalMax: { type: Number, lowercase: true },
  practicalMin: { type: Number, lowercase: true },
